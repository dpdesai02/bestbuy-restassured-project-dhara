...
public class StoresAssertionTest {
    ...
    @Test
    public void test03() {
response.body("data[1].city",equalTo("Inver Grove Heights"));
    ...
    public void test04() {
        ...
        //6. Check hash map values ‘createdAt’ inside storeservices map where store map where store name = Roseville
        @Test
        public void test06 () {
